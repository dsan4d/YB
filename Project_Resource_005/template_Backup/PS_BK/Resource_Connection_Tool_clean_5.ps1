...
function submit_btn_Click {
    ...
    if ($DatePicker_end_edit_lbl.text -eq $DISPLAY_NULL){
        ...
        if ($true) {
            ...
            #$confirm_lbl.text = (Get-ChildItem -Path JD:\Basis_DBA).name
            $confirm_lbl.text = ""
...
<#Extra Refresh_Text on GUI
$RefreshButton = New-Object System.Windows.Forms.Button
$RefreshButton.Location = New-Object System.Drawing.Size(200,400)
$RefreshButton.Size = New-Object System.Drawing.Size(120,23)
$RefreshButton.Text = "Refresh"
$RefreshButton.Add_Click({cancel_btn_Click}) 
#$Refresh:Path = [System.Environment]::GetEnvironmentVariable("{$job}")
#>

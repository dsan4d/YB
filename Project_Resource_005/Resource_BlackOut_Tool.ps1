...
#Describe: Jams ...
#
#Process: first draft completed$EnvironmentServer
#
...
$f_template_start_Path = "C:\Users\DB8.admin\Desktop\Project_Resource_005\template\t_Job_source_stop.txt"
$f_generated_start_Path = "C:\Users\DB8.admin\Desktop\Project_Resource_005\generated\g_Job_source_stop.txt"

$f_template_stop_Path = "C:\Users\DB8.admin\Desktop\Project_Resource_005\template\t_Job_source_start.txt"
$f_generated_stop_Path = "C:\Users\DB8.admin\Desktop\Project_Resource_005\generated\g_Job_source_start.txt"
...
New-PSDrive JD -PSProvider JAMS -Root $EnvironmentServer -ErrorAction SilentlyContinue

$EnvironmentServer = Get-Content -Path "C:\Users\DB8.admin\Desktop\Project_Resource_005\private\Server_List.txt"

write-host $EnvironmentServer
...
Function Stop_Services_btn_click {
    $msg1 = "WARNING: This will stop the JAMS Services. Do you want to do this? "
    $Resp= [System.Windows.Forms.MessageBox]::Show($msg1, 'Warning', 'YesNo', 'Warning')
    if ($Resp -eq "Yes") {
        write-host "stopping services ...."
        #Start-Process C:\Users\DB8.admin\Desktop\Project_Resource_005\addons\stop-manual.bat
        #Runs batch file as admin
        Start-Process -filepath C:\Users\DB8.admin\Desktop\Project_Resource_005\addons\stop-manual.bat -Verb Runas
    }
...
Function Start_Services_btn_click {
    $msg1 = "WARNING: This will start the JAMS Services. Do you want to do this? "
    $Resp = [System.Windows.Forms.MessageBox]::Show($msg1, 'Warning', 'YesNo', 'Warning')
    if ($Resp -eq "Yes") {
        write-host "starting services ...."
       #Start-Process C:\Users\DB8.admin\Desktop\Project_Resource_005\addons\start-delayed.bat
       #Runs batch file as admin
     Start-Process -filepath C:\Users\DB8.admin\Desktop\Project_Resource_005\addons\start-delayed.bat -Verb Runas
...
function submit_btn_Click {
    ...
    if ($DatePicker_end_edit_lbl.text -eq $DISPLAY_NULL){
        ...
        if ($true) {
            ...
            $JAMS_Resources_Search_Path = "JAMS::$EnvironmentServer\Resources\" + $Name
            ...
            $ScheduleTrigger_begin = [MVPSI.JAMS.ScheduleTrigger]::New("$Schedule_start",[MVPSI.JAMS.TimeOfDay]"$r1_stime_str")
            $ScheduleTrigger_end = [MVPSI.JAMS.ScheduleTrigger]::New("$Schedule_end",[MVPSI.JAMS.TimeOfDay]"$r2_stime_str")
            ...
            $confirm_lbl.text = ""
            (Get-ChildItem -Path JD:\Basis_DBA).name | %{ $confirm_lbl.text += $_.tostring() + [char]13+[char]10}
        }
    }
...
#[array]$EnvironmentServer = "FFVWJAMAS01D", "FFVWJAMAS01Q", "FFVWJAMAS01P"

# This Function Returns the Selected Value and Closes the Form
#function Return-DropDown {
#$script:Choice = $EnvironmentServer.SelectedItem.ToString()
...
$Form.width = 300
$Form.height = 150
$Form.Text = ”Blackout Tool”
$Form.BackColor = "AntiqueWhite"
...
$envButton.Location = new-object System.Drawing.Size(100,50)
$envButton.Size = new-object System.Drawing.Size(100,20)
$envButton.Text = "Choose Env"
$envButton.Add_Click({Return-DropDown})
...
#New-PSDrive JD -PSProvider JAMS -Root FFVWJAMAS01D -ErrorAction SilentlyContinue
New-PSDrive JD -PSProvider JAMS -Root $EnvironmentServer -ErrorAction SilentlyContinue

$JAMS_Resources_Search_Path = "JAMS::$EnvironmentServer\Resources\" + $Name

#Main Window
$jobs = (Get-ChildItem -Path JD:\$EnvironmentServer\resources).Name
#$jobs = (Get-ChildItem -Path JD:\FFVWJAMAS01D\resources).Name
$main_form = New-Object System.Windows.Forms.Form
$main_form.Text ='JAMS Resource Blackout Tool'
#$main_form.Width = 600
...
$CancelButton.Location = New-Object System.Drawing.Size(300,400)
$CancelButton.Size = New-Object System.Drawing.Size(120,23)
$CancelButton.Text = "Cancel"
$CancelButton.Add_Click({cancel_btn_Click})

#StopServices on GUI
$stp_Srvcs_Button = New-Object System.Windows.Forms.Button
#$stp_Srvcs_Button.Location = New-Object System.Drawing.Size(300,375)
$stp_Srvcs_Button.Location = New-Object System.Drawing.Size(300,675)
$stp_Srvcs_Button.Size = New-Object System.Drawing.Size(120,23)
$stp_Srvcs_Button.Text = "Stop Services"
$stp_Srvcs_Button.Add_Click({Stop_Services_btn_click})
#$stp_Srvcs_Button.Add_Click({C:\Users\DB8.admin\Desktop\Project_Resource_005\addons\stop-manual.bat})

#StartServices on GUI
$strt_Srvcs_Button = New-Object System.Windows.Forms.Button
#$strt_Srvcs_Button.Location = New-Object System.Drawing.Size(100,375)
$strt_Srvcs_Button.Location = New-Object System.Drawing.Size(100,675)
$strt_Srvcs_Button.Size = New-Object System.Drawing.Size(120,23)
$strt_Srvcs_Button.Text = "Start Services"
$strt_Srvcs_Button.Add_Click({Start_Services_btn_click})

#env on GUI
New-Object System.Drawing.Point(500,40)
$env_lbl = New-Object System.Windows.Forms.Label
$env_lbl.Text = "Environment:"
$env_lbl.Location  = New-Object System.Drawing.Point(11,475)
$env_lbl.AutoSize = $true

##Env_Combobox on GUI
$env_Box = New-Object System.Windows.Forms.ComboBox
$env_Box.Width = 300
$env_Box.datasource = $EnvironmentServer
#$env_Box.Add_Click({submit_btn_Click})
$env_Box.Location  = New-Object System.Drawing.Point(95,475)

$env_Button = new-object System.Windows.Forms.Button
$env_Button.Location = new-object System.Drawing.Size(95,500)
$env_Button.Size = new-object System.Drawing.Size(150,20)
$env_Button.Text = "Choose Env"
#$env_Button.Add_Click({Return-DropDown})
$env_Button.Add_Click({$EnvironmentServer})
...
#confirm title_label
$confirm_Title_lbl = New-Object System.Windows.Forms.Label
$confirm_Title_lbl.Location  = New-Object System.Drawing.Point(11,120)
$confirm_Title_lbl.size = '30,23'
$confirm_Title_lbl.BackColor = [System.Drawing.color]::white
$confirm_Title_lbl.ForeColor = [System.Drawing.color]::black
$confirm_Title_lbl.text = "Jobs"
$confirm_Title_lbl.BackColor = "AntiqueWhite"

#confirm label
$confirm_lbl = New-Object System.Windows.Forms.Label
$confirm_lbl.Location  = New-Object System.Drawing.Point(50,130) #(50,325)
$confirm_lbl.size = '500,200'#'500,23'
$confirm_lbl.BackColor = [System.Drawing.color]::white
$confirm_lbl.ForeColor = [System.Drawing.color]::Green
#$confirm_lbl

#Calendar_Begin_Maintenance Icon Image
$DatePicker_begin_lbl = New-Object System.Windows.Forms.Label
$DatePicker_begin_lbl.BackgroundImage = [System.drawing.image]::FromFile('C:\Users\DB8.admin\Desktop\Project_Resource_005\images\CalendarPic.gif')
...
$DatePicker_end_lbl.BackgroundImage = [System.drawing.image]::FromFile('C:\Users\DB8.admin\Desktop\Project_Resource_005\images\CalendarPic.gif')
...
$main_form.Controls.Add($confirm_Title_lbl)
$main_form.Controls.Add($confirm_lbl)
$main_form.Controls.Add($SubmitButton)
$main_form.Controls.Add($CancelButton)
$main_form.Controls.Add($stp_Srvcs_Button)
$main_form.Controls.Add($strt_Srvcs_Button)
$main_form.Controls.Add($env_lbl)
$main_form.Controls.Add($env_box)
$main_form.Controls.Add($env_Button)
...
write-output $env_Box.datasource
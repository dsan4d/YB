...
Function Stop_Services_btn_click {
    ...
    if ($Resp -eq "Yes") {
      ...
      Start-Process C:\Users\DB8.admin\Desktop\Project_Resource_test\addons\stop-manual.bat
    }
...
Function Start_Services_btn_click {
    ...
    if ($Resp -eq "Yes") {
       ...
       Start-Process C:\Users\DB8.admin\Desktop\Project_Resource_test\addons\start-delayed.bat
    }
}
...
#$stp_Srvcs_Button.Add_Click({C:\Users\DB8.admin\Desktop\Project_Resource_test\addons\stop-manual.bat})
